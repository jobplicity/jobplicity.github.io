			...
			advisors: [
				{
					...
					description:
						"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since ",
				},
				{
					name: "Maxine Sherin",
  ...
  <p>Our panel of advisors consists of Australian leaders in their fields.</p>
    <div class="advisor-item"  v-for="(advisor,index) in advisors" :key="index">
      ...
      <div class="advisor-about">
        <h3>{{advisor.name}}</h3>
        <h4>{{advisor.role}}</h4>
        <p>{{getExcerpt(advisor.description)}} </p>
    ...
    <div class="current-advisor" :class="{'show':showCurrentAdvisor}" @click="hideAbout()">
       <div class="advisor-item" @click.prevent.stop="">
        ...
        <p>{{currentAdvisor.description}} </p>

		...
		return {
			content: {
				...
				description: `
					<h4>Overview</h4>
					<p>
						Please read this agreement carefully before accessing or using the information and services available through the Launch website (“Site”). By accessing or using the Site, you agree to be bound by the terms and conditions below. Launch may modify this agreement at any time, and such modifications shall be effective immediately upon posting the modified agreement on the Site. Company terms and conditions must be accepted and adhered to by Companies who use Launch's services and the Site. Launch also has a comprehensive privacy policy for users of the Site.
					</p>
					...
					<p>
					By using Launch you acknowledge & agree to granting Launch a license to represent you and source micro-job applications on your behalf for jobs posted on Freelancer websites across the Internet.
					</p>
					...
					<p>
					You acknowledge and agree that information published by Launch is intended to provide general information in summary form on market insights, legal and other issues. Launch does not warrant the accuracy or completeness of such information.
					</p>
					<p>
					Launch does not endorse or recommend any of the jobs, business or self-employment opportunities advertised on its Site and Launch strongly recommends that prior to entering into any agreement with any of the Companies on the Site, that you obtain your own independent legal, accounting, financial or taxation advice as appropriate. It is solely your responsibility to evaluate the accuracy, completeness and usefulness of all opinions, advice, services, merchandise and other information provided through the Site or on the Internet generally.
					</p>
					<p>
					In no event will Launch be liable to you or anyone else for any decision made or action taken by you or anyone else in reliance upon any information contained on or omitted from the Site.
					</p>


					<h4>No guarantees of job micro-job vacancy</h4>
					<p>
					Launch gives no guarantee to you of the continued availability of any particular micro-job advertised on the Site and will not be liable to you should a Company have filled the vacancy at any time prior to removal of the advertisement from the Site.
					</p>
					<p>
					Whilst Launch takes efforts to ensure that micro-jobs advertised are for actual job vacancies, it gives no guarantee to you that every job advertisement represents an actual job vacancy.
					</p>

					<h4>No guarantees as to the service</h4>
					<p>
					Launch provides no warranty to you that the services generally available through its Site will be uninterrupted or error-free or that defects in the service will be corrected. You also understand that Launch cannot and does not guarantee or warrant to you that files available for downloading through the Site or delivered via electronic mail through the Site will be free of infection or viruses, worms, Trojan horses or other code that manifest contaminating or destructive properties. You are responsible for implementing sufficient procedures and checkpoints to satisfy your particular requirements for accuracy of data input and output, and for maintaining a means external to the Site for the reconstruction of any lost data.
					</p>

					<h4>Our rights to use information you send us</h4>
					<p>
					Launch welcomes ideas and feedback from you about all aspects of the Site. You agree that Launch may reproduce, distribute, transmit, create derivative works of, and publicly display any materials and other information (including ideas for new or improved products and services) that you submit to any public areas of the Site (such as bulletin boards, forums and newsgroups) or by email to Launch. (Please read our privacy policy for more information as to how we deal with information you send to us.)
					</p>

					<h4>No guarantees as to security of your information</h4>
					<p>
					While Launch takes all due care in ensuring the privacy and integrity of the information you provide, the possibility exists that this information could be unlawfully observed by a third party while in transit over the Internet or while stored on Launch systems or on Launch's Site. Launch disclaims all liability to you to the greatest extent possible pursuant to law should this occur.
					</p>
					...
					<p>
					You agree to immediately notify Launch of any unauthorized use of your login name or any other breach of security known to you.
					</p>

					<h4>No misrepresentations allowed</h4>
					<p>
					You agree that it is a condition on your use of the Launch Site and of any other services provided by Launch or through the Site that you will not through any act or omission (including but not limited to creating a profile on the Launch Site) mislead or deceive others.
					</p>
